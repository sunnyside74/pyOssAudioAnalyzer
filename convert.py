...
# imp_name = '대구범어성당 IR'
# imp_name = '돈화문국악당'
# imp_name = '세종문화회관 대극장 IR-01'
# imp_name = '세종문화회관 채임버홀'
# imp_name = '승동교회 IR'
# imp_name = '아람누리 음악당 IR'
# imp_name = '아람콘서트홀 IR'
# imp_name = '애터미공연장 IR-01'
# imp_name = '우란문화재단 공연장 IR-01'
# imp_name = '울산중구문화의전당 IR-01'
# imp_name = '전주완산여고 IR'
# imp_name = '천안예술의전당 IR-01'
# imp_name = '청주아트홀 IR'
# imp_name = '풍류홀 IR'
# imp_name = '한국문화의집 IR'
...
############################################################################################
chunk_conv, data_conv, st_fmt_conv, t_conv = pyOssWavfile.readf32( imp_fname, samplerate=48000 )
